...
class duedatecalculatorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/duedatecalculator');
        }
        ...
        this.validationRules = {"last_period":{"type":"string","required":true,"format":"date"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/duedatecalculator`);
        }
    }
...
module.exports = duedatecalculatorWrapper;
