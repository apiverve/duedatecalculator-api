...
const (
	baseURL        = "https://api.apiverve.com/v1/duedatecalculator"
	defaultTimeout = 30 * time.Second
)

// Client is the Due Date Calculator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Due Date Calculator API client.
...
// Execute makes a request to the Due Date Calculator API with typed parameters.
//
