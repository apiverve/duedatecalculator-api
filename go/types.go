// Package duedatecalculator provides a Go client for the Due Date Calculator API.
//
// For more information, visit: https://apiverve.com/marketplace/duedatecalculator?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Due Date Calculator API.
//
// Parameters:
...
// ResponseData contains the data returned by the Due Date Calculator API.
type ResponseData struct {
	CalculationMethod string `json:"calculation_method"`
	LastPeriodDate string `json:"last_period_date"`
	EstimatedConceptionDate string `json:"estimated_conception_date"`
	DueDate string `json:"due_date"`
	CurrentProgress CurrentProgressData `json:"current_progress"`
	TimeUntilDue TimeUntilDueData `json:"time_until_due"`
	UpcomingMilestones []interface{} `json:"upcoming_milestones"`
	ImportantDates ImportantDatesData `json:"important_dates"`
	Disclaimer string `json:"disclaimer"`
}

// CurrentProgressData represents the current_progress object.
type CurrentProgressData struct {
	DaysPregnant int `json:"days_pregnant"`
	WeeksPregnant int `json:"weeks_pregnant"`
	DaysIntoWeek int `json:"days_into_week"`
	Formatted string `json:"formatted"`
	Trimester int `json:"trimester"`
	PercentageComplete float64 `json:"percentage_complete"`
}

// TimeUntilDueData represents the time_until_due object.
type TimeUntilDueData struct {
	Days int `json:"days"`
	Weeks int `json:"weeks"`
	DaysExtra int `json:"days_extra"`
	Formatted string `json:"formatted"`
	IsOverdue bool `json:"is_overdue"`
}

// ImportantDatesData represents the important_dates object.
type ImportantDatesData struct {
	EndFirstTrimester string `json:"end_first_trimester"`
	EndSecondTrimester string `json:"end_second_trimester"`
	FullTermBegins string `json:"full_term_begins"`
}
