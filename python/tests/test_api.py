...
class TestDuedatecalculatorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = DuedatecalculatorAPIClient(self.api_key)

    @patch('apiverve_duedatecalculator.apiClient.requests.get')
