...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/duedatecalculator',
        'Source': 'https://github.com/apiverve/duedatecalculator-api',
        'Bug Tracker': 'https://github.com/apiverve/duedatecalculator-api/issues'
    },
    classifiers=[
