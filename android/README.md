# Due Date Calculator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:duedatecalculator-api:1.1.13'
}
```
...
```java
import com.apiverve.duedatecalculator.DueDateCalculatorAPIClient;
import com.apiverve.duedatecalculator.APIResponse;
import com.apiverve.duedatecalculator.APIException;

// Initialize the client
DueDateCalculatorAPIClient client = new DueDateCalculatorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/duedatecalculator](https://docs.apiverve.com/ref/duedatecalculator)
...
- **Documentation:** [https://docs.apiverve.com/ref/duedatecalculator](https://docs.apiverve.com/ref/duedatecalculator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/duedatecalculator-api/issues)
