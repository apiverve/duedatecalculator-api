...
namespace APIVerve\Duedatecalculator;
...
/**
 * Client for the Due Date Calculator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/duedatecalculator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/duedatecalculator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\DuedatecalculatorClient] {$message}\n";
        }
    }
}
